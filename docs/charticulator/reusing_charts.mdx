...
You can export chart designs as a Power BI Custom Visual (.pbiviz), which can be imported into Power BI. Check out how you can [use the chart design in Power BI](/docs/using-in-power-bi.html).
