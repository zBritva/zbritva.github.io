...
![Fertility Rate vs. Life Expectancy](/images/gallery/fertility_rate_vs_life_expectancy.png)
...
<Player url="/videos/gallery/fertility_rate_life_expectancy.mp4"/>

## Dataset

[gapminder.csv](/data/gapminder.csv)