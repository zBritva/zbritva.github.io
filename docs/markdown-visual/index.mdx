...
<button className="donate stripe" onClick={() => window.open('https://buy.stripe.com/00wbJ10AmdUIbQuewhgUM00', '_blank')}>Stripe</button>

<button className="donate github" onClick={() => window.open('https://github.com/sponsors/aveirun', '_blank')}>GitHub</button>
